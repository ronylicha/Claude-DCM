...
echo "╠══════════════════════════════════════════════════════╣"
echo "║                                                      ║"
echo "║  Recommended: Use the dcm CLI                        ║"
echo "║    ./dcm install        # Full setup with supervisor ║"
echo "║    ./dcm status         # Check health               ║"
echo "║    ./dcm supervisor status  # Supervisor details     ║"
echo "║                                                      ║"
echo "║  Manual start (without supervisor):                  ║"
